...
function BottomTabNavigator() {
  ...
  return (
    <BottomTab.Navigator
      ...
      <BottomTab.Screen
        name="Home"
        component={login ? Event : Walkthrough}
        options={{
          title: t('home'),
          tabBarIcon: ({color}) => {
      ...
      <BottomTab.Screen
        name="Expenses"
        component={login ? FlightSummary : Walkthrough}
        options={{
          title: 'Expenses',
          tabBarIcon: ({color}) => {
            return (
              <Icon color={color} name="money-check-alt" size={20} solid />
            );
          },
        }}
      />
      <BottomTab.Screen
        name="Create"
        component={login ? DashboardEvent : Walkthrough}
        options={{
          title: 'Create',
          tabBarIcon: ({color}) => {
            return <Icon solid color={color} name="folder-plus" size={20} />;
          },
        }}
      />
      <BottomTab.Screen
        name="Post"
        component={login ? Notification : Walkthrough}
        options={{
          title: 'Friends',
          tabBarIcon: ({color}) => {
            return <Icon color={color} name="id-card" size={20} solid />;
          },
        }}
      />
      <BottomTab.Screen
